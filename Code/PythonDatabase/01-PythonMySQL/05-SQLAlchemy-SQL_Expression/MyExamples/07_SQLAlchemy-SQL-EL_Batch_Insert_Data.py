# 文件名：07_SQLAlchemy-SQL_Expression_Batch_Insert_Data.py
# 功能说明：通过SQLAlchemy-SQL_Expression（MySQL+PyMySQL）向数据表中批量插入数据记录
...
#----------------------------------------------------------------------------
sql_insert = mytable.insert()
# 定义多条记录变量
var_insert = [{'name':'Google', 'url':'https://www.google.com'},
...
# 六、执行SQL语句
#----------------------------------------------------------------------------
try:    # 执行SQL语句（插入多条数据记录）
    myresult = myconn.execute(sql_insert, var_insert)
    # 插入数据记录成功给出提示
